  ...
  content: [
    ...
    },
    {
      ...
      options: [
        ...
        "D. Check the required checkbox on the Loss Reason field in Object Manger.",
      ],
      answer: "B",
      title: "Question 11",
    },
    ...
    },
    {
      ...
      options: [
        ...
        "B. Sharing setting are ignored by contacts displayed in the Contact Hierarchy.",
        "C. Customizing hierarchy columns changes the recently viewed Contacts list view.",
        "D. Contact Hierarchy is limited to only 3,000 contacts at one time.",
      ],
      answer: "A",
      title: "Question 33",
    },
    {
      ...
      options: [
        ...
        "B. Create a new role for the subject matter experts and give them access to the records with the owner-based sharing rule",
        ...
        "D. Enable territory management, assign the subject matter experts to the same territory, and give them access to the records with manual sharing.",
      ],
      answer: "A",
      title: "Question 34",
    },
    ...
    },
    {
      ...
      options: [
        ...
        "D. Create a Chatter Private Group.",
      ],
      answer: "D",
      title: "Question 47",
    },
    {
      ...
      options: [
        ...
        "C. Existing field values will retain unchanged.",
    ...
    },
    {
      ...
      options: [
        "A. Specify initial submission actions within the approval process.",
        "B. Update the organizations chatter setting to allow approvals.",
        "C. Enable the organizations Email approval response setting.",
    ...
    },
    {
      ...
      options: [
        "A. The field needs to be restored from the recycle bin.",
    ...
    },
    {
      ...
      options: [
        "A. Remove fields from the record details component.",
