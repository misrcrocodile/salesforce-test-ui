...
window.testContent[testName].testList.push({
  name: "SalesforceAdmin1.ADM-201.v2022-08-25.q79",
  content: [
    {
      content:
    ...
    },
    {
      ...
      options: [
        ...
        "C. Accounts should have a master-detail to Shipments.",
    ...
    },
    {
      ...
      options: [
        "A. Make the field required and move it to the top of the page.",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Require use of Password Manager App",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Build the dashboards manually to meet the deadline.",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Create six record types, each with 1 page layout.",
        "C. Create one record type with six Page Layouts.",
    ...
    },
    {
      ...
      options: [
        "A. Flow to create recurring tasks.",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Make Lead Source a dependent picklist to the Opportunity stage field.",
    ...
    {
      content:
        "The Cloud kicks sales manager wants to boost productivity by providing insights at the start of each day. Which three sales-specific standard Lightning components should administrator add to the homepage to meet this requirement? Choose 2 Answers.",
      options: [
        "A. Path",
        "B. Key Deals",
        "C. Activities",
