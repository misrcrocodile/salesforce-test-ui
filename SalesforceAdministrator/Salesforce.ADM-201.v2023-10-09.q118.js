...
window.testContent[testName].testList.push({
  name: "SalesforceAdmin1.ADM-201.v2023-10-09.q118",
  content: [
    {
      content:
    ...
    },
    {
      ...
      options: [
        "A. Create and assign a permission set that includes Read, Create, and Edit access",
    ...
    },
    {
      ...
      options: [
        "A. Customize Opportunity Contact Role.",
    ...
    },
    {
      ...
      options: [
        "A. User Management settings in setup.",
    ...
    {
      content:
        "Ursa Major Solar is noticing a decrease in deals with a cross-sell opportunity type and wants to share all cross-sell opportunities with a team of subject matter experts in their organisation. The company has different roles, and the organisation wide default opportunity is set to private.\nHow should the administrator accomplish this?",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        "D. Write a Validation Rule to ensure the Account has a value in that field.",
      ],
      answer: "B",
      title: "Question 30",
      explanation: "",
    ...
    },
    {
      ...
      options: [
        "A. Modify the closed won value associated with the stage.",
        "B. Change the probability associated with the stage.",
        "C. Adjust the forecast category associated with the stage.",
        "D. Update the expected revenue associated with the stage.",
      ],
      answer: "B",
      title: "Question 34",
      explanation: "",
    ...
    },
    {
      ...
      options: [
        ...
        "C. The data is restorable from the recycle bin.",
    ...
    },
    {
      ...
      options: [
        ...
        "C. Run a Campaign report and update any Member information via Data Loader.",
    ...
    },
    {
      ...
      options: [
        ...
        "C. Create one page layout. Use record types to ensure the proper status picklist values display.",
    ...
    },
    {
      ...
      options: [
        ...
        "D. Create business processes and record types for each of the three product categories.",
      ],
      answer: "B",
      title: "Question 53",
      explanation: "",
    ...
    },
    {
      ...
      options: [
        ...
        "B. An autolaunched flow on the order page that updates all open orders shipping addresses whenever the account shipping addresses changes.",
        ...
        "D. An autolaunched flow on the account page that updates all open orders shipping addresses whenever the account shipping addresses changes.",
      ],
      answer: "D",
      title: "Question 55",
      explanation: "",
    ...
    },
    {
      ...
      options: [
        ...
        "C. Turn on Task Notifications service.",
    ...
    },
    {
      ...
      options: ["A. Queues", "B. Splits", "C. List Views", "D. Stages"],
      answer: "B",
      title: "Question 65",
      explanation: "",
    },
    {
      ...
      options: [
        "A. Create an Escalation Rules to send cases to the correct queue.",
        "B. Utilize a flow to identify the correct queue and assign the case.",
        "C. Use a custom email services to set the owner of the case upon creation.",
    ...
    },
    {
      ...
      options: [
        ...
        "D. The custom report type is in development.",
      ],
      answer: "A,B",
      title: "Question 67",
      explanation: "",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Any metadata changes to the package have to be recreated in production.",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Use the native debug feature in the flow builder.",
    ...
    },
    {
      ...
      title: "Question 72",
      explanation:
        "The two automation tools that an administrator should use to automatically create a renewal opportunity when a cloud kicks Opportunity closes are:\n Process Builder: Process Builder is an automation tool that enables administrators to create automated processes that can perform complex actions based on certain criteria. In this case, the administrator can create a process that triggers when an Opportunity is closed due to a cloud kick and automatically creates a renewal opportunity.\n Workflow Rule: Workflow Rule is another automation tool that enables administrators to automate certain actions based on certain criteria. In this case, the administrator can create a workflow rule that triggers when an Opportunity is closed due to a cloud kick and automatically creates a renewal opportunity.\n Therefore, the correct answers are C. Workflow Rule and D. Process Builder.",
    },
    {
      content:
    ...
    },
    {
      ...
      options: [
        "A. hare the Support Reports folder with Support Agents with View Access.",
    ...
    },
    {
      ...
      options: [
        "A. Add Help Text so the user knows to only add a Showing Date within the current year.",
        "B. Sync the users' Showing Calendar to Salesforce and filter it to only look at this year.",
        "C. Create a report that shows any Showing Dates not scheduled in the current year to the updated.",
    ...
    },
    {
      ...
      options: [
        "A. From the page layout editor, drag the field to the highlights panel.",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Create a new report folder with viewer access.",
        "C. Move the dashboard to the user's private folder.",
    ...
    },
    {
      ...
      title: "Question 108",
      explanation:
        "To ensure that the Billing System field is filled on every Invoice record, the administrator should make the field universally required. This means that the field will be required on every page layout and record type, regardless of any other settings or conditions.\n Creating a Process Builder to set the field or defining an approval process for the child would not necessarily ensure that the field is always filled, as these processes may not run for every record.\n Requiring the field on the record type would only apply to records of that specific type, and if the administrator later added a new record type or changed the default record type, the requirement may not be enforced.\n Therefore, making the field universally required is the best way to ensure that the requirement is consistently enforced across all Invoice records.",
    },
    {
      content:
    ...
    },
    {
      ...
      options: [
        ...
        "B. Use the $Record global variable.",
        "C. Use the Get Records element to find the Id.",
        "D. Use the {!Contact.Id} global variable.",
      ],
      answer: "B",
      title: "Question 116",
      explanation: "",
