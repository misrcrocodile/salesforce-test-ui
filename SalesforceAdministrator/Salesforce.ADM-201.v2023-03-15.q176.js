...
window.testContent[testName].testList.push({
  ...
  content: [
    ...
    {
      content:
        "Which of the following is a standard Profile? Choose 2 answers.",
      options: [
        "A. Sales User",
        "B. Marketing User",
        "C. Invoice Manager",
    ...
    {
      content: "Which of the statements are true for Cases: Choose 3 answers.",
      options: [
    ...
    },
    {
      content:
        "The administrator at Ursa Major Solar has been asked to change the work Item and Project Custom Object Relationship from a master detail to a Lookup.\nWhich Scenario Could prevent the administrator from fulfilling this requirement?",
      options: [
        "A. Roll-Up summary field exist on the master object.",
